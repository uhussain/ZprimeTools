...
public :
  ...
  TH2F *h_EcalPtUnc[46],*h_TrackerPtUnc[46],*h_HcalPtUnc[46];
  TH1F *h_TrackerPtFrac[46],*h_EcalPtFrac[46],*h_HcalPtFrac[46];
  //3Const.
  TH1F *h_j1PFCons1PtFraction[46],*h_j1PFCons2PtFraction[46],*h_j1PFCons3PtFraction[46];  
  ...
  while ((filename = (TSystemFile*)nextlist()) && fileNumber >  maxFiles)
    {
      ...
      TString dataset = "ZprimeSignalJobs_July10-MonoZprime_";
