...
void ZprimeJetsClass::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  for (Long64_t jentry=0; jentry<nentriesToCheck;jentry+=4) {
    ...
    //return a vector containing by index: 0=Pt123Fraction, 1=Pt1Fraction, 2=Pt2Fraction, 3=Pt3Fraction
...
void ZprimeJetsClass::fillHistos(std::vector<std::pair<int,double>> jetCand_to_use,int histoNumber)
{
  ...
  if(jetCand_to_use.size()>0){
    ...
    h_j1PFCons1PtFraction[histoNumber]->Fill(PtFraction_to_use[1]);
    h_j1PFCons2PtFraction[histoNumber]->Fill(PtFraction_to_use[2]);
    h_j1PFCons3PtFraction[histoNumber]->Fill(PtFraction_to_use[3]);
  }
}
//This function returns a vector
std::vector<double>ZprimeJetsClass::getPt123Frac(int UncType)
{
...
//This function returns a vector with 0=Pt123Fraction, 1=Pt1Fraction,2=Pt2Fraction,3=Pt3Fraction
std::vector<double>ZprimeJetsClass::getPtFrac(int UncType)
{
