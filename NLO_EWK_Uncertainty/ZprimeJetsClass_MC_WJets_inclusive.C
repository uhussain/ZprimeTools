...
void ZprimeJetsClass_MC_WJets::Loop(Long64_t maxEvents, int reportEvery)
{
  ...
  for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++) {
    ...
    double NLO_EWK_corrected_weight=1.0;
	...
	NLO_weight_avg/=3;
        ...
        event_weight*=kfactor; //event_weight = event_weight*kfactor
        nFilters+=event_weight; //nFilters = nFilters + event_weight
...
void ZprimeJetsClass_MC_WJets::getPt123Frac(std::vector<std::pair<int,double>> jetCand,int UncType)
{
