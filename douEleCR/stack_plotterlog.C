...
void stack_plotterlog()
{
  system("hadd -f postSingleEle_final.root postSingleEle_0.root postSingleEle_1.root postSingleEle_2.root");
  ...
  TH1F *histo_j1EtaWidth_data_0 = (TH1F*)f_datafile_0->Get("h_dileptonM_8");
  //TH1F *histo_j1EtaWidth_data_1 = (TH1F*)f_datafile_1->Get("h_dileptonM_8");
  ...
  TH1F *histo_j1EtaWidth_WJets_0 = (TH1F*)WJets_Files[0]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W1Jets = (TH1F*)WJets_Files[1]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W2Jets = (TH1F*)WJets_Files[2]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W3Jets = (TH1F*)WJets_Files[3]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W4Jets = (TH1F*)WJets_Files[4]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W5Jets = (TH1F*)WJets_Files[5]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W6Jets = (TH1F*)WJets_Files[6]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W7Jets = (TH1F*)WJets_Files[7]->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_WJets_0->Scale((1.0/WJets_Total[0])*3723.664*50690);
  histo_j1EtaWidth_W1Jets->Scale((1.0/WJets_Total[1])*3723.664*1345);
  histo_j1EtaWidth_W2Jets->Scale((1.0/WJets_Total[2])*3723.664*359.7);
  histo_j1EtaWidth_W3Jets->Scale((1.0/WJets_Total[3])*3723.664*48.91);
  histo_j1EtaWidth_W4Jets->Scale((1.0/WJets_Total[4])*3723.664*12.05);
  histo_j1EtaWidth_W5Jets->Scale((1.0/WJets_Total[5])*3723.664*5.501);
  histo_j1EtaWidth_W6Jets->Scale((1.0/WJets_Total[6])*3723.664*1.329);
  histo_j1EtaWidth_W7Jets->Scale((1.0/WJets_Total[7])*3723.664*0.03216);
  ...
  TH1F *histo_j1EtaWidth_100to200 = (TH1F*)Zvv_Files[0]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_200to400 = (TH1F*)Zvv_Files[1]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_400to600 = (TH1F*)Zvv_Files[2]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_600to800 = (TH1F*)Zvv_Files[3]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_800to1200 = (TH1F*)Zvv_Files[4]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_1200to2500 = (TH1F*)Zvv_Files[5]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_2500toInf = (TH1F*)Zvv_Files[6]->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_100to200->Scale((1.0/Zvv_Total[0])*3723.664*280.35);
  histo_j1EtaWidth_200to400->Scale((1.0/Zvv_Total[1])*3723.664*77.67);
  histo_j1EtaWidth_400to600->Scale((1.0/Zvv_Total[2])*3723.664*10.73);
  histo_j1EtaWidth_600to800->Scale((1.0/Zvv_Total[3])*3723.664*2.559);
  histo_j1EtaWidth_800to1200->Scale((1.0/Zvv_Total[4])*3723.664*1.1796);
  histo_j1EtaWidth_1200to2500->Scale((1.0/Zvv_Total[5])*3723.664*0.28833);
  histo_j1EtaWidth_2500toInf->Scale((1.0/Zvv_Total[6])*3723.664*0.006945);
  ...
  TH1F *histo_j1EtaWidth_G1Jets = (TH1F*)GJets_Files[0]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G2Jets = (TH1F*)GJets_Files[1]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G3Jets = (TH1F*)GJets_Files[2]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G4Jets = (TH1F*)GJets_Files[3]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G5Jets = (TH1F*)GJets_Files[4]->Get("h_dileptonM_8");
  ...
  //Scaling
  histo_j1EtaWidth_G1Jets->Scale((1.0/GJets_Total[0])*3723.664*17420);
  histo_j1EtaWidth_G2Jets->Scale((1.0/GJets_Total[1])*3723.664*5391);
  histo_j1EtaWidth_G3Jets->Scale((1.0/GJets_Total[2])*3723.664*1168);
  histo_j1EtaWidth_G4Jets->Scale((1.0/GJets_Total[3])*3723.664*132.5);
  histo_j1EtaWidth_G5Jets->Scale((1.0/GJets_Total[4])*3723.664*44.05);
...
//opening DYJetsToLL backgrounds
  ...
  TH1F *histo_j1EtaWidth_DY1Jets = (TH1F*)DYJets_Files[0]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY2Jets = (TH1F*)DYJets_Files[1]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY3Jets = (TH1F*)DYJets_Files[2]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY4Jets = (TH1F*)DYJets_Files[3]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY5Jets = (TH1F*)DYJets_Files[4]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY6Jets = (TH1F*)DYJets_Files[5]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY7Jets = (TH1F*)DYJets_Files[6]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY8Jets = (TH1F*)DYJets_Files[7]->Get("h_dileptonM_8");
  ...
  //histo_j1EtaWidth_DY1Jets->Scale((1.0/96657400)*3723.664*4895);
  histo_j1EtaWidth_DY1Jets->Scale((1.0/DYJets_Total[0])*3723.664*4895);
  histo_j1EtaWidth_DY2Jets->Scale((1.0/DYJets_Total[1])*3723.664*148);
  histo_j1EtaWidth_DY3Jets->Scale((1.0/DYJets_Total[2])*3723.664*40.94);
  histo_j1EtaWidth_DY4Jets->Scale((1.0/DYJets_Total[3])*3723.664*5.497);
  histo_j1EtaWidth_DY5Jets->Scale((1.0/DYJets_Total[4])*3723.664*1.354);
  histo_j1EtaWidth_DY6Jets->Scale((1.0/DYJets_Total[5])*3723.664*0.6250);
  histo_j1EtaWidth_DY7Jets->Scale((1.0/DYJets_Total[6])*3723.664*0.1511);
  histo_j1EtaWidth_DY8Jets->Scale((1.0/DYJets_Total[7])*3723.664*0.003647);
  ...
  TH1F *histo_j1EtaWidth_TTJets = (TH1F*)TTJets_Files[0]->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_TTJets->Scale((1.0/TTJets_Total[0])*3723.664*502.2);
 ...
 //addding some backgrounds like WW, WZ, ZZ	
  ...
  TH1F *histo_j1EtaWidth_WW = (TH1F*)WW_Files[0]->Get("h_dileptonM_8");
  histo_j1EtaWidth_WW->SetStats(0);
  histo_j1EtaWidth_WW->Scale((1.0/WW_Total[0])*3723.664*118.7);
...
*/
  ...
  TH1F *histo_j1EtaWidth_WZ = (TH1F*)WZ_Files[0]->Get("h_dileptonM_8");
  histo_j1EtaWidth_WZ->SetStats(0);
  histo_j1EtaWidth_WZ->Scale((1.0/WZ_Total[0])*3723.664*47.2);
...
*/
  ...
  TH1F *histo_j1EtaWidth_ZZ = (TH1F*)ZZ_Files[0]->Get("h_dileptonM_8");
  histo_j1EtaWidth_ZZ->SetStats(0);
  histo_j1EtaWidth_ZZ->Scale((1.0/ZZ_Total[0])*3723.664*16.6);
...
*/
 ...
 //opening QCD background files (METValue-binned samples)
  ...
  TH1F *histo_j1EtaWidth_Q1Jets = (TH1F*)QJets_Files[0]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q2Jets = (TH1F*)QJets_Files[1]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q3Jets = (TH1F*)QJets_Files[2]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q4Jets = (TH1F*)QJets_Files[3]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q5Jets = (TH1F*)QJets_Files[4]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q6Jets = (TH1F*)QJets_Files[5]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q7Jets = (TH1F*)QJets_Files[6]->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q8Jets = (TH1F*)QJets_Files[7]->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_Q1Jets->Scale((1.0/QJets_Total[0])*3723.664*27500000);
  histo_j1EtaWidth_Q2Jets->Scale((1.0/QJets_Total[1])*3723.664*1735000);
  histo_j1EtaWidth_Q3Jets->Scale((1.0/QJets_Total[2])*3723.664*367000);
  histo_j1EtaWidth_Q4Jets->Scale((1.0/QJets_Total[3])*3723.664*29370);
  histo_j1EtaWidth_Q5Jets->Scale((1.0/QJets_Total[4])*3723.664*6524);
  histo_j1EtaWidth_Q6Jets->Scale((1.0/QJets_Total[5])*3723.664*1064);
  histo_j1EtaWidth_Q7Jets->Scale((1.0/QJets_Total[6])*3723.664*121.5);
  histo_j1EtaWidth_Q8Jets->Scale((1.0/QJets_Total[7])*3723.664*25.42);  
  ...
  //TH1F *histo_signal_1GeV = (TH1F*)f_signal_1GeVfile ->Get("h_dileptonM_8");
  //histo_signal_1GeV->Scale((1.0/629)*3723.664*0.056);
  ...
  //TH1F *histo_signal_5GeV = (TH1F*)f_signal_5GeVfile ->Get("h_dileptonM_8");
  //histo_signal_5GeV->Scale((1.0/2133)*3723.664*0.047);
...
////
  ...
  //TH1F *histo_signal_10GeV = (TH1F*)f_signal_10GeVfile ->Get("h_dileptonM_8");
  //histo_signal_10GeV->Scale((1.0/4052)*3723.664*0.04);
  ...
  //TH1F *histo_signal_20GeV = (TH1F*)f_signal_20GeVfile ->Get("h_dileptonM_8");
  //histo_signal_20GeV->Scale((1.0/9998)*3723.664*0.034);
  ...
  //TH1F *histo_signal_50GeV = (TH1F*)f_signal_50GeVfile ->Get("h_dileptonM_8");
  //histo_signal_50GeV->Scale((1.0/9999)*3723.664*0.025);
...
////  
  ...
  //TH1F *histo_signal_100GeV = (TH1F*)f_signal_100GeVfile ->Get("h_dileptonM_8");
  //histo_signal_100GeV->Scale((1.0/9994)*3723.664*0.019);
  ...
  TLatex *texS = new TLatex(0.20,0.837173,"#sqrt{s} = 13 TeV, 3.72 fb^{-1}");
  texS->SetNDC();
  texS->SetTextFont(42);
  ...
  TGaxis *xaxis = new TGaxis(60,0,120,0,60,120,510);
  xaxis->SetTitle("Dilepton Mass (GeV)");
  ...
  TGaxis *yaxis = new TGaxis(60,0,60,2.2,0,2.2,6,"");
...
*/
  c->SaveAs("CRPlots_EWK/datamc_h_dileptonM_8_extra_G.pdf");
  c->SaveAs("CRPlots_EWK/datamc_h_dileptonM_8_extra_G.png");
}
