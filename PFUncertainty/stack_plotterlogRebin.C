...
void stack_plotterlogRebin()
{
  ...
  //opening the data file and adding "pfMET_11" histogram
  TFile *f_datafile_0 = new TFile("postMETdata_final.root");
  //TFile *f_datafile_1 = new TFile("postMETdata_1.root");
  TH1F *histo_j1EtaWidth_data_0_old = (TH1F*)f_datafile_0->Get("pfMET_11"); 
 ...
 // double xbins[2]={-20,20};
  ...
  //TH1F *histo_j1EtaWidth_data_1 = (TH1F*)f_datafile_1->Get("pfMET_11");
  ...
  TH1F *histo_j1EtaWidth_WJets_0_old = (TH1F*)f_WJets_0->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W1Jets_old = (TH1F*)f_W1Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W2Jets_old = (TH1F*)f_W2Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W3Jets_old = (TH1F*)f_W3Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W4Jets_old = (TH1F*)f_W4Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W5Jets_old = (TH1F*)f_W5Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W6Jets_old = (TH1F*)f_W6Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_W7Jets_old = (TH1F*)f_W7Jets->Get("pfMET_11");
  ...
  histo_j1EtaWidth_WJets_0->Scale((1.0/57025300)*12609.751*50690);
  histo_j1EtaWidth_W1Jets->Scale((1.0/39617100)*12609.751*1345);
  histo_j1EtaWidth_W2Jets->Scale((1.0/19914100)*12609.751*359.7);
  histo_j1EtaWidth_W3Jets->Scale((1.0/5795950)*12609.751*48.91);
  histo_j1EtaWidth_W4Jets->Scale((1.0/14907300)*12609.751*12.05);
  histo_j1EtaWidth_W5Jets->Scale((1.0/6200210)*12609.751*5.501);
  histo_j1EtaWidth_W6Jets->Scale((1.0/5527630)*12609.751*1.329);
  histo_j1EtaWidth_W7Jets->Scale((1.0/2382300)*12609.751*0.03216);
  ...
  TH1F *histo_j1EtaWidth_100to200_old = (TH1F*)f_Zvv_100to200->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_200to400_old = (TH1F*)f_Zvv_200to400->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_400to600_old = (TH1F*)f_Zvv_400to600->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_600to800_old = (TH1F*)f_Zvv_600to800->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_800to1200_old = (TH1F*)f_Zvv_800to1200->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_1200to2500_old = (TH1F*)f_Zvv_1200to2500->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_2500toInf_old = (TH1F*)f_Zvv_2500toInf->Get("pfMET_11");
  ...
  histo_j1EtaWidth_100to200->Scale((1.0/19026300)*12609.751*280.35);
  histo_j1EtaWidth_200to400->Scale((1.0/19611900)*12609.751*77.67);
  histo_j1EtaWidth_400to600->Scale((1.0/8842310)*12609.751*10.73);
  histo_j1EtaWidth_600to800->Scale((1.0/5763180)*12609.751*2.559);
  histo_j1EtaWidth_800to1200->Scale((1.0/2169900)*12609.751*1.1796);
  histo_j1EtaWidth_1200to2500->Scale((1.0/143919)*12609.751*0.28833);
  histo_j1EtaWidth_2500toInf->Scale((1.0/404725)*12609.751*0.006945);
  ...
  TH1F *histo_j1EtaWidth_G1Jets_old = (TH1F*)f_G1Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_G2Jets_old = (TH1F*)f_G2Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_G3Jets_old = (TH1F*)f_G3Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_G4Jets_old = (TH1F*)f_G4Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_G5Jets_old = (TH1F*)f_G5Jets->Get("pfMET_11");
  ...
  //Scaling
  histo_j1EtaWidth_G1Jets->Scale((1.0/11490000)*12609.751*17420);
  histo_j1EtaWidth_G2Jets->Scale((1.0/14375000)*12609.751*5391);
  histo_j1EtaWidth_G3Jets->Scale((1.0/49455800)*12609.751*1168);
  histo_j1EtaWidth_G4Jets->Scale((1.0/11582100)*12609.751*132.5);
  histo_j1EtaWidth_G5Jets->Scale((1.0/11611900)*12609.751*44.05);
...
//opening DYJetsToLL backgrounds
  ...
  TH1F *histo_j1EtaWidth_DY1Jets_old = (TH1F*)f_DY1Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY2Jets_old = (TH1F*)f_DY2Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY3Jets_old = (TH1F*)f_DY3Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY4Jets_old = (TH1F*)f_DY4Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY5Jets_old = (TH1F*)f_DY5Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY6Jets_old = (TH1F*)f_DY6Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY7Jets_old = (TH1F*)f_DY7Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_DY8Jets_old = (TH1F*)f_DY8Jets->Get("pfMET_11");
  ...
  histo_j1EtaWidth_DY1Jets->Scale((1.0/47644783)*12609.751*4895*1.23);
  histo_j1EtaWidth_DY2Jets->Scale((1.0/7855800)*12609.751*147.4*1.23);
  histo_j1EtaWidth_DY3Jets->Scale((1.0/8691200)*12609.751*40.99*1.23);
  histo_j1EtaWidth_DY4Jets->Scale((1.0/8937770)*12609.751*5.678*1.23);
  histo_j1EtaWidth_DY5Jets->Scale((1.0/8292150)*12609.751*1.367*1.23);
  histo_j1EtaWidth_DY6Jets->Scale((1.0/2668260)*12609.751*0.6304*1.23);
  histo_j1EtaWidth_DY7Jets->Scale((1.0/555134)*12609.751*0.1514*1.23);
  histo_j1EtaWidth_DY8Jets->Scale((1.0/398370)*12609.751*0.003565*1.23);
  ...
  TH1F *histo_j1EtaWidth_TTJets_old = (TH1F*)f_TTJets->Get("pfMET_11");
  ...
  histo_j1EtaWidth_TTJets->Scale((1.0/10139700)*12609.751*502.2);
 ...
 //addding some backgrounds like WW, WZ, ZZ	
  ...
  TH1F *histo_j1EtaWidth_WW_old = (TH1F*)f_WW->Get("pfMET_11");
  ...
  histo_j1EtaWidth_WW->Scale((1.0/6986980)*12609.751*118.7);
...
*/
  ...
  TH1F *histo_j1EtaWidth_WZ_old = (TH1F*)f_WZ->Get("pfMET_11");
  ...
  histo_j1EtaWidth_WZ->Scale((1.0/2995760)*12609.751*47.2);
...
*/
  ...
  TH1F *histo_j1EtaWidth_ZZ_old = (TH1F*)f_ZZ->Get("pfMET_11"); 
  ...
  histo_j1EtaWidth_ZZ->Scale((1.0/998014)*12609.751*16.6);
...
*/
 ...
 //opening QCD background files (METValue-binned samples)
  ...
  TH1F *histo_j1EtaWidth_Q1Jets_old = (TH1F*)f_Q1Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q2Jets_old = (TH1F*)f_Q2Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q3Jets_old = (TH1F*)f_Q3Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q4Jets_old = (TH1F*)f_Q4Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q5Jets_old = (TH1F*)f_Q5Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q6Jets_old = (TH1F*)f_Q6Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q7Jets_old = (TH1F*)f_Q7Jets->Get("pfMET_11");
  TH1F *histo_j1EtaWidth_Q8Jets_old = (TH1F*)f_Q8Jets->Get("pfMET_11");
  ...
  histo_j1EtaWidth_Q1Jets->Scale((1.0/80584300)*12609.751*27500000);
  histo_j1EtaWidth_Q2Jets->Scale((1.0/38742400)*12609.751*1735000);
  histo_j1EtaWidth_Q3Jets->Scale((1.0/37501400)*12609.751*367000);
  histo_j1EtaWidth_Q4Jets->Scale((1.0/43210300)*12609.751*29370);
  histo_j1EtaWidth_Q5Jets->Scale((1.0/29695500)*12609.751*6524);
  histo_j1EtaWidth_Q6Jets->Scale((1.0/10358900)*12609.751*1064);
  histo_j1EtaWidth_Q7Jets->Scale((1.0/7853460)*12609.751*121.5);
  histo_j1EtaWidth_Q8Jets->Scale((1.0/4045060)*12609.751*25.42);  
...
//  TH1F *histo_signal_1GeV = (TH1F*)f_signal_1GeVfile ->Get("pfMET_11");
//  histo_signal_1GeV->Scale((1.0/629)*12609.751*0.056);
...
//
  ...
  TH1F *histo_signal_5GeV_old = (TH1F*)f_signal_5GeVfile ->Get("pfMET_11");
  TH1F *histo_signal_5GeV = dynamic_cast<TH1F*>(histo_signal_5GeV_old->Rebin(28,"histo_signal_5GeV",xbins));
  histo_signal_5GeV->Scale((1.0/2133)*12609.751*0.047);
...
//  TH1F *histo_signal_20GeV = (TH1F*)f_signal_20GeVfile ->Get("pfMET_11");
//  histo_signal_20GeV->Scale((1.0/10000)*12609.751*0.034);
...
//  TH1F *histo_signal_50GeV = (TH1F*)f_signal_50GeVfile ->Get("pfMET_11");
//  histo_signal_50GeV->Scale((1.0/10000)*12609.751*0.025);
...
//  TH1F *histo_signal_10GeV = (TH1F*)f_signal_10GeVfile ->Get("pfMET_11");
//  histo_signal_10GeV->Scale((1.0/4052)*12609.751*0.04);
...
//  TH1F *histo_signal_100GeV = (TH1F*)f_signal_100GeVfile ->Get("pfMET_11");
//  histo_signal_100GeV->Scale((1.0/10000)*12609.751*0.019);
...
//  leg->AddEntry(histo_signal_100GeV, "ZprimeSignal_mchi100GeV");
  ...
  TLatex *texS = new TLatex(0.20,0.837173,"#sqrt{s} = 13 TeV, 12.61 fb^{-1}");
  texS->SetNDC();
  texS->SetTextFont(42);
  ...
  for(int ibin=8; ibin<=nbins;ibin++) {
...
*/
  c->SaveAs("corrPU/datamc_pfMET_11_Rebin.pdf");
  c->SaveAs("corrPU/datamc_pfMET_11_Rebin.png");
}
