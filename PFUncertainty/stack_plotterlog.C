...
void stack_plotterlog()
{
  ...
  //opening the data file and adding "pfMET_13" histogram
  TFile *f_datafile_0 = new TFile("postMETdata_final.root");
  //TFile *f_datafile_1 = new TFile("postMETdata_1.root");
  TH1F *histo_j1EtaWidth_data_0 = (TH1F*)f_datafile_0->Get("pfMET_13");
  //TH1F *histo_j1EtaWidth_data_1 = (TH1F*)f_datafile_1->Get("pfMET_13");
  ...
  TH1F *histo_j1EtaWidth_WJets_0 = (TH1F*)f_WJets_0->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W1Jets = (TH1F*)f_W1Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W2Jets = (TH1F*)f_W2Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W3Jets = (TH1F*)f_W3Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W4Jets = (TH1F*)f_W4Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W5Jets = (TH1F*)f_W5Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W6Jets = (TH1F*)f_W6Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_W7Jets = (TH1F*)f_W7Jets->Get("pfMET_13");
  ...
  histo_j1EtaWidth_W6Jets->Scale((1.0/5288560)*12609.751*1.329);
  ...
  TH1F *histo_j1EtaWidth_100to200 = (TH1F*)f_Zvv_100to200->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_200to400 = (TH1F*)f_Zvv_200to400->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_400to600 = (TH1F*)f_Zvv_400to600->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_600to800 = (TH1F*)f_Zvv_600to800->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_800to1200 = (TH1F*)f_Zvv_800to1200->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_1200to2500 = (TH1F*)f_Zvv_1200to2500->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_2500toInf = (TH1F*)f_Zvv_2500toInf->Get("pfMET_13");
  ...
  TH1F *histo_j1EtaWidth_G1Jets = (TH1F*)f_G1Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_G2Jets = (TH1F*)f_G2Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_G3Jets = (TH1F*)f_G3Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_G4Jets = (TH1F*)f_G4Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_G5Jets = (TH1F*)f_G5Jets->Get("pfMET_13");
...
//opening DYJetsToLL backgrounds
  ...
  TH1F *histo_j1EtaWidth_DY1Jets = (TH1F*)f_DY1Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY2Jets = (TH1F*)f_DY2Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY3Jets = (TH1F*)f_DY3Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY4Jets = (TH1F*)f_DY4Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY5Jets = (TH1F*)f_DY5Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY6Jets = (TH1F*)f_DY6Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY7Jets = (TH1F*)f_DY7Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_DY8Jets = (TH1F*)f_DY8Jets->Get("pfMET_13");
  ...
  TH1F *histo_j1EtaWidth_TTJets = (TH1F*)f_TTJets->Get("pfMET_13");
 ...
 //addding some backgrounds like WW, WZ, ZZ	
  ...
  TH1F *histo_j1EtaWidth_WW = (TH1F*)f_WW->Get("pfMET_13");
...
*/
  ...
  TH1F *histo_j1EtaWidth_WZ = (TH1F*)f_WZ->Get("pfMET_13");
...
*/
  ...
  TH1F *histo_j1EtaWidth_ZZ = (TH1F*)f_ZZ->Get("pfMET_13");
...
*/
 ...
 //opening QCD background files (METValue-binned samples)
  ...
  TH1F *histo_j1EtaWidth_Q1Jets = (TH1F*)f_Q1Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q2Jets = (TH1F*)f_Q2Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q3Jets = (TH1F*)f_Q3Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q4Jets = (TH1F*)f_Q4Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q5Jets = (TH1F*)f_Q5Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q6Jets = (TH1F*)f_Q6Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q7Jets = (TH1F*)f_Q7Jets->Get("pfMET_13");
  TH1F *histo_j1EtaWidth_Q8Jets = (TH1F*)f_Q8Jets->Get("pfMET_13");
...
//  TH1F *histo_signal_1GeV = (TH1F*)f_signal_1GeVfile ->Get("pfMET_13");
...
//
  ...
  TH1F *histo_signal_5GeV = (TH1F*)f_signal_5GeVfile ->Get("pfMET_13");
...
//  TH1F *histo_signal_20GeV = (TH1F*)f_signal_20GeVfile ->Get("pfMET_13");
...
//  TH1F *histo_signal_50GeV = (TH1F*)f_signal_50GeVfile ->Get("pfMET_13");
...
//  TH1F *histo_signal_10GeV = (TH1F*)f_signal_10GeVfile ->Get("pfMET_13");
...
//  TH1F *histo_signal_100GeV = (TH1F*)f_signal_100GeVfile ->Get("pfMET_13");
...
*/
  c->SaveAs("corrPU/datamc_pfMET_13_BCD.pdf");
  c->SaveAs("corrPU/datamc_pfMET_13_BCD.png");
}
