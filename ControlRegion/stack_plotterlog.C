...
void stack_plotterlog()
{
  ...
  TH1F *histo_j1EtaWidth_WJets_0 = (TH1F*)f_WJets_0->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W1Jets = (TH1F*)f_W1Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W2Jets = (TH1F*)f_W2Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W3Jets = (TH1F*)f_W3Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W4Jets = (TH1F*)f_W4Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W5Jets = (TH1F*)f_W5Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W6Jets = (TH1F*)f_W6Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_W7Jets = (TH1F*)f_W7Jets->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_WJets_0->Scale((1.0/57025279)*3723.664*50690);
  histo_j1EtaWidth_W1Jets->Scale((1.0/39617081)*3723.664*1345);
  histo_j1EtaWidth_W2Jets->Scale((1.0/19914060)*3723.664*359.7);
  histo_j1EtaWidth_W3Jets->Scale((1.0/5795947)*3723.664*48.91);
  histo_j1EtaWidth_W4Jets->Scale((1.0/14907334)*3723.664*12.05);
  histo_j1EtaWidth_W5Jets->Scale((1.0/6200214)*3723.664*5.501);
  histo_j1EtaWidth_W6Jets->Scale((1.0/5288556)*3723.664*1.329);
  histo_j1EtaWidth_W7Jets->Scale((1.0/2382305)*3723.664*0.03216);
  ...
  TH1F *histo_j1EtaWidth_100to200 = (TH1F*)f_Zvv_100to200->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_200to400 = (TH1F*)f_Zvv_200to400->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_400to600 = (TH1F*)f_Zvv_400to600->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_600to800 = (TH1F*)f_Zvv_600to800->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_800to1200 = (TH1F*)f_Zvv_800to1200->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_1200to2500 = (TH1F*)f_Zvv_1200to2500->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_2500toInf = (TH1F*)f_Zvv_2500toInf->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_100to200->Scale((1.0/19026284)*3723.664*280.35);
  histo_j1EtaWidth_200to400->Scale((1.0/19611913)*3723.664*77.67);
  histo_j1EtaWidth_400to600->Scale((1.0/8842306)*3723.664*10.73);
  histo_j1EtaWidth_600to800->Scale((1.0/5763181)*3723.664*2.559);
  histo_j1EtaWidth_800to1200->Scale((1.0/2169896)*3723.664*1.1796);
  histo_j1EtaWidth_1200to2500->Scale((1.0/143919)*3723.664*0.28833);
  histo_j1EtaWidth_2500toInf->Scale((1.0/404725)*3723.664*0.006945);
  ...
  TH1F *histo_j1EtaWidth_G1Jets = (TH1F*)f_G1Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G2Jets = (TH1F*)f_G2Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G3Jets = (TH1F*)f_G3Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G4Jets = (TH1F*)f_G4Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_G5Jets = (TH1F*)f_G5Jets->Get("h_dileptonM_8");
  ...
  //Scaling
  histo_j1EtaWidth_G1Jets->Scale((1.0/11490000)*3723.664*17420);
  histo_j1EtaWidth_G2Jets->Scale((1.0/14375000)*3723.664*5391);
  histo_j1EtaWidth_G3Jets->Scale((1.0/49455800)*3723.664*1168);
  histo_j1EtaWidth_G4Jets->Scale((1.0/11582100)*3723.664*132.5);
  histo_j1EtaWidth_G5Jets->Scale((1.0/11611900)*3723.664*44.05);
...
//opening DYJetsToLL backgrounds
  ...
  TH1F *histo_j1EtaWidth_DY1Jets = (TH1F*)f_DY1Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY2Jets = (TH1F*)f_DY2Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY3Jets = (TH1F*)f_DY3Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY4Jets = (TH1F*)f_DY4Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY5Jets = (TH1F*)f_DY5Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY6Jets = (TH1F*)f_DY6Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY7Jets = (TH1F*)f_DY7Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_DY8Jets = (TH1F*)f_DY8Jets->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_DY1Jets->Scale((1.0/96657366)*3723.664*4895);
  histo_j1EtaWidth_DY2Jets->Scale((1.0/7549150)*3723.664*148);
  histo_j1EtaWidth_DY3Jets->Scale((1.0/4628596)*3723.664*40.94);
  histo_j1EtaWidth_DY4Jets->Scale((1.0/155583)*3723.664*5.497);
  histo_j1EtaWidth_DY5Jets->Scale((1.0/8292160)*3723.664*1.354);
  histo_j1EtaWidth_DY6Jets->Scale((1.0/2668311)*3723.664*0.6250);
  histo_j1EtaWidth_DY7Jets->Scale((1.0/595906)*3723.664*0.1511);
  histo_j1EtaWidth_DY8Jets->Scale((1.0/399147)*3723.664*0.003647);
  ...
  TH1F *histo_j1EtaWidth_TTJets = (TH1F*)f_TTJets->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_TTJets->Scale((1.0/10139700)*3723.664*502.2);
 ...
 //addding some backgrounds like WW, WZ, ZZ	
  ...
  TH1F *histo_j1EtaWidth_WW = (TH1F*)f_WW->Get("h_dileptonM_8");
  histo_j1EtaWidth_WW->SetStats(0);
  histo_j1EtaWidth_WW->Scale((1.0/6987020)*3723.664*118.7);
...
*/
  ...
  TH1F *histo_j1EtaWidth_WZ = (TH1F*)f_WZ->Get("h_dileptonM_8");
  histo_j1EtaWidth_WZ->SetStats(0);
  histo_j1EtaWidth_WZ->Scale((1.0/2995780)*3723.664*47.2);
...
*/
  ...
  TH1F *histo_j1EtaWidth_ZZ = (TH1F*)f_ZZ->Get("h_dileptonM_8");
  histo_j1EtaWidth_ZZ->SetStats(0);
  histo_j1EtaWidth_ZZ->Scale((1.0/998018)*3723.664*16.6);
...
*/
 ...
 //opening QCD background files (METValue-binned samples)
  ...
  TH1F *histo_j1EtaWidth_Q1Jets = (TH1F*)f_Q1Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q2Jets = (TH1F*)f_Q2Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q3Jets = (TH1F*)f_Q3Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q4Jets = (TH1F*)f_Q4Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q5Jets = (TH1F*)f_Q5Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q6Jets = (TH1F*)f_Q6Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q7Jets = (TH1F*)f_Q7Jets->Get("h_dileptonM_8");
  TH1F *histo_j1EtaWidth_Q8Jets = (TH1F*)f_Q8Jets->Get("h_dileptonM_8");
  ...
  histo_j1EtaWidth_Q1Jets->Scale((1.0/80584300)*3723.664*27500000);
  histo_j1EtaWidth_Q2Jets->Scale((1.0/38742400)*3723.664*1735000);
  histo_j1EtaWidth_Q3Jets->Scale((1.0/37501400)*3723.664*367000);
  histo_j1EtaWidth_Q4Jets->Scale((1.0/43210300)*3723.664*29370);
  histo_j1EtaWidth_Q5Jets->Scale((1.0/29695500)*3723.664*6524);
  histo_j1EtaWidth_Q6Jets->Scale((1.0/10358900)*3723.664*1064);
  histo_j1EtaWidth_Q7Jets->Scale((1.0/7853460)*3723.664*121.5);
  histo_j1EtaWidth_Q8Jets->Scale((1.0/4045060)*3723.664*25.42);  
