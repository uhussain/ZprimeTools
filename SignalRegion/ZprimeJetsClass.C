...
void ZprimeJetsClass::fillHistos(std::vector<std::pair<int,double>> jetCand_to_use,int histoNumber)
{
  ...
  h_j1Pt[histoNumber]->Fill(jetPt->at(jetCand_to_use[0].first));
  ...
  h_PF123PtFraction[histoNumber]->Fill(PtFraction_to_use[0]);//Pt123/j1PtAllCons
  h_PF123PtFraction_v2[histoNumber]->Fill(PtFraction_to_use[5]);//Pt123/jetPt
  h_j1PtAllCons[histoNumber]->Fill(PtFraction_to_use[4]);//j1PtAllCons
  ...
  h_j1TotPFCands[histoNumber]->Fill(TotalLowEnPFCandidates);
  ...
  h_j1MiscPFCands[histoNumber]->Fill(MiscPFCandidates);
  h_j1TotPFCandsPtFraction[histoNumber]->Fill(TotLowEnPFCandsPtFraction);
  h_j1ChPFCandsPtFraction[histoNumber]->Fill(ChPFCandsPtFraction); 
  h_j1GammaPFCandsPtFraction[histoNumber]->Fill(GammaPFCandsPtFraction);
  h_j1NeutPFCandsPtFraction[histoNumber]->Fill(NeutralPFCandsPtFraction);
  h_j1MiscPFCandsPtFraction[histoNumber]->Fill(MiscPFCandsPtFraction);
  ...
  if(j1PFConsPID.size()>0){
    h_j1PFCons1Pt[histoNumber]->Fill(j1PFConsPt.at(0));
    h_j1PFCons1PID[histoNumber]->Fill(j1PFConsPID.at(0));
    h_j1PFCons1PtFraction[histoNumber]->Fill((j1PFConsPt.at(0)/jetPt->at(jetCand_to_use[0].first)));}
  if(j1PFConsPID.size()>1){
    h_j1PFCons2Pt[histoNumber]->Fill(j1PFConsPt.at(1));
    h_j1PFCons2PID[histoNumber]->Fill(j1PFConsPID.at(1));
    h_j1PFCons2PtFraction[histoNumber]->Fill((j1PFConsPt.at(1)/jetPt->at(jetCand_to_use[0].first)));}
  if(j1PFConsPID.size()>2){
    h_j1PFCons3Pt[histoNumber]->Fill(j1PFConsPt.at(2));
    h_j1PFCons3PID[histoNumber]->Fill(j1PFConsPID.at(2));
    h_j1PFCons3PtFraction[histoNumber]->Fill((j1PFConsPt.at(2)/jetPt->at(jetCand_to_use[0].first)));}
  }
}
std::vector<double>ZprimeJetsClass::getPtFrac()
{
...
void ZprimeJetsClass::AllPFCand(std::vector<std::pair<int,double>> jetCand, std::vector<std::pair<int,double>>PFCands)
{
...
std::vector<int> ZprimeJetsClass::JetVetoDecision() {
...
std::vector<std::pair<int,double>>ZprimeJetsClass::getPFCandidates(){
