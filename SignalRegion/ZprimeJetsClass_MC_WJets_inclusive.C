...
void ZprimeJetsClass_MC_WJets::AllPFCand(std::vector<std::pair<int,double>> jetCand, std::vector<std::pair<int,double>>PFCands)
{
...
std::vector<std::pair<int,double>>ZprimeJetsClass_MC_WJets::getPFCandidates(){
