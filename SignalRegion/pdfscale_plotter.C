...
void plot(string xaxis_variable, string filename, Float_t int_lumi, Float_t nevents, Float_t xsec)
{
  ...
  TString inputName_default = TString(histname_input+"_110");
  TString inputName_facUp = TString(histname_input+"_102");
  TString inputName_facDown = TString(histname_input+"_103");
  TString inputName_renUp = TString(histname_input+"_104");
  TString inputName_renDown = TString(histname_input+"_107");
  TString inputName_bothUp = TString(histname_input+"_105");
  TString inputName_bothDown = TString(histname_input+"_109");
...
void pdfscale_plotter()
{
  ...
  filenames.push_back("ZnnG_pdfscale_ZNuNuGJets");
  int_lumis.push_back(35900.0);
  nevents.push_back(2040365.0);
  xsecs.push_back(0.18213);
  filenames.push_back("ZnnG_pdfscale_ZNuNuGJets_ext");
  int_lumis.push_back(35900.0);
  nevents.push_back(2040365.0);
  xsecs.push_back(0.18213);
  
  filenames.push_back("ZnnG_pdfscale_WGJets");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("ZnnG_pdfscale_WGJets_ext");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("ZnnG_pdfscale_WGJets_mitExt");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  
  filenames.push_back("ZnnG_pdfscale_ZLLGJets_130_under300");
  int_lumis.push_back(35900.0);
  nevents.push_back(489423.0);
  xsecs.push_back(0.148);
  filenames.push_back("ZnnG_pdfscale_ZLLGJets_300");
  int_lumis.push_back(35900.0);
  nevents.push_back(1707773.0);
  xsecs.push_back(0.0092);
  
  filenames.push_back("ZeeG_pdfscale_ZLLGJets_130_under300");
  int_lumis.push_back(35900.0);
  nevents.push_back(489423.0);
  xsecs.push_back(0.148);
  filenames.push_back("ZeeG_pdfscale_ZLLGJets_300");
  int_lumis.push_back(35900.0);
  nevents.push_back(1707773.0);
  xsecs.push_back(0.0092);

  filenames.push_back("ZmmG_pdfscale_ZLLGJets_130_under300");
  int_lumis.push_back(35900.0);
  nevents.push_back(489423.0);
  xsecs.push_back(0.148);
  filenames.push_back("ZmmG_pdfscale_ZLLGJets_300");
  int_lumis.push_back(35900.0);
  nevents.push_back(1707773.0);
  xsecs.push_back(0.0092);
  
  filenames.push_back("WenG_pdfscale_ZLLGJets_130_under300");
  int_lumis.push_back(35900.0);
  nevents.push_back(489423.0);
  xsecs.push_back(0.148);
  filenames.push_back("WenG_pdfscale_ZLLGJets_300");
  int_lumis.push_back(35900.0);
  nevents.push_back(1707773.0);
  xsecs.push_back(0.0092);

  filenames.push_back("WmnG_pdfscale_ZLLGJets_130_under300");
  int_lumis.push_back(35900.0);
  nevents.push_back(489423.0);
  xsecs.push_back(0.148);
  filenames.push_back("WmnG_pdfscale_ZLLGJets_300");
  int_lumis.push_back(35900.0);
  nevents.push_back(1707773.0);
  xsecs.push_back(0.0092);

  filenames.push_back("WenG_pdfscale_WGJets");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("WenG_pdfscale_WGJets_ext");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("WenG_pdfscale_WGJets_mitExt");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);

  filenames.push_back("WmnG_pdfscale_WGJets");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("WmnG_pdfscale_WGJets_ext");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);
  filenames.push_back("WmnG_pdfscale_WGJets_mitExt");
  int_lumis.push_back(35900.0);
  nevents.push_back(30469887.0);
  xsecs.push_back(0.65521);

  // filenames.push_back("ZnnG_pdfscale_DM_V_Mx1_Mv500");
  // int_lumis.push_back(35900.0);
  // nevents.push_back(50000.0);
  // xsecs.push_back(0.07464);
  // filenames.push_back("ZnnG_pdfscale_DM_V_Mx1_Mv1000");
  // int_lumis.push_back(35900.0);
  // nevents.push_back(50000.0);
  // xsecs.push_back(0.01446);
  // filenames.push_back("ZnnG_pdfscale_DM_V_Mx1_Mv2000");
  // int_lumis.push_back(35900.0);
  // nevents.push_back(50000.0);
  // xsecs.push_back(0.001207);


  std::cout<<"-----------------------------"<<std::endl;
  std::cout<<"Pt:"<<std::endl;
  for(int i = 0; i < filenames.size(); i++){
    plot("Pt",filenames[i],int_lumis[i],nevents[i],xsecs[i]);
    // DEBUG
  ...
  for(int i = 0; i < filenames.size(); i++){
    plot("Mt",filenames[i],int_lumis[i],nevents[i],xsecs[i]);
  }
  std::cout<<"-----------------------------"<<std::endl;
}