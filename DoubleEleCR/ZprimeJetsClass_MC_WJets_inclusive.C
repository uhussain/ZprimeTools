...
void ZprimeJetsClass_MC_WJets::BookHistos(const char* file2)
{
  ...
  float MetBins[51]={200.,220.,240.,260.,280.,300.,320.,340.,360.,380.,400.,420.,440.,460.,480.,500.,520.,540.,560.,580.,600.,620.,640.,660.,680.,700.,720.,740.,760.,
...
std::vector<int> ZprimeJetsClass_MC_WJets::JetVetoDecision(int leading_ele_index, int subleading_ele_index) {
