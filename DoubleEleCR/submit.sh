...
#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset1/180529_*/0000/ postDoubleEle_0.root -1 10000 Ele_0

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset1/180529_*/0001/ postDoubleEle_1.root -1 10000 Ele_1

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset1/180529_*/0002/ postDoubleEle_2.root -1 10000 Ele_2

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset1/180529_*/0003/ postDoubleEle_3.root -1 10000 Ele_3

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset2/180529_*/0000/ postDoubleEle_4.root -1 10000 Ele_4

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset2/180529_*/0001/ postDoubleEle_5.root -1 10000 Ele_5

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset3/180529_*/0000/ postDoubleEle_6.root -1 10000 Ele_6

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset3/180529_*/0001/ postDoubleEle_7.root -1 10000 Ele_7

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset4/180529_*/0000/ postDoubleEle_8.root -1 10000 Ele_8

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset4/180529_*/0001/ postDoubleEle_9.root -1 10000 Ele_9

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset5/180529_*/0000/ postDoubleEle_10.root -1 10000 Ele_10

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset5/180529_*/0001/ postDoubleEle_11.root -1 10000 Ele_11

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset6/180529_*/0000/ postDoubleEle_12.root -1 10000 Ele_12

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset6/180529_*/0001/ postDoubleEle_13.root -1 10000 Ele_13

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset6/180529_*/0002/ postDoubleEle_14.root -1 10000 Ele_14

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset7/180529_*/0000/ postDoubleEle_15.root -1 10000 Ele_15  

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset7/180529_*/0001/ postDoubleEle_16.root -1 10000 Ele_16  

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset7/180529_*/0002/ postDoubleEle_17.root -1 10000 Ele_17  

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset7/180529_*/0003/ postDoubleEle_18.root -1 10000 Ele_18  

#./MakeCondorFiles_data.csh analyzedata /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_DATA}_CR/SingleElectron/crab_dataset8/180529_*/0000/ postDoubleEle_19.root -1 10000 Ele_19 
...
./MakeCondorFiles_WZ.csh analyze1 /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJetsToLL/180528_*/0000/ postDY_MLM_0.root -1 10000 DYMLM_0 kfactors.root PU_Central.root

#./rootcom ZprimeJetsClass_MC_ZJets analyzeZJets

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-100to200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT100to200/180528_*/0000/ postDY100to200.root -1 10000 DY100 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-200to400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT200to400/180528_*/0000/ postDY200to400.root -1 10000 DY200 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-400to600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT400to600/180528_*/0000/ postDY400to600.root -1 10000 DY400 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-600to800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT600to800/180528_*/0000/ postDY600to800.root -1 10000 DY600 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-800to1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT800to1200/180528_*/0000/ postDY800to1200.root -1 10000 DY800 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-1200to2500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT1200to2500/180528_*/0000/ postDY1200to2500.root -1 10000 DY1200 kfactors.root PU_Central.root

#./MakeCondorFiles_WZ.csh analyze /hdfs/store/user/uhussain/Zprime_Ntuples_${DATE}/DYJetsToLL_M-50_HT-2500toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/crab_DYJets_HT2500toInf/180528_*/0000/ postDY2500toInf.root -1 10000 DY2500 kfactors.root PU_Central.root
