...
public :
  ...
  TH1F *h_nVtx[44],*h_metcut, *h_dphimin,*h_metFilters[44],*h_pfMETall[44],*h_pfMET200[44],*h_nJets[44],*h_pfMET[44],*h_pfMETPhi[44],*h_j1nCategory1[44],*h_j1nCategory2[44],*h_j1dRPF12_ID_1[44],*h_j1dRPF12_ID_2[44];
  TH1F *h_j1Pt[44], *h_j1Eta[44], *h_j1Phi[44], *h_j1etaWidth[44], *h_j1phiWidth[44],*h_j1nCons[44], *h_j1PF12PtFrac_ID_1[44], *h_j1PF12PtFrac_ID_2[44],*h_j1PFPtFrac_ID_2[44],*h_PF123PtFraction[44];  
  TH1F *h_j1TotPFCands[44], *h_j1ChPFCands[44], *h_j1NeutPFCands[44], *h_j1GammaPFCands[44], *h_j1CHF[44], *h_j1NHF[44], *h_j1ChMultiplicity[44], *h_j1NeutMultiplicity[44],*h_j1Mt[44]; 
  //Category3 Histos
  TH1F *h_ChPionPt[44],*h_PhotonPt[44],*h_dRPionPhoton[44];
  TH1D *h_cutflow;
