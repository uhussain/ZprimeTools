...
public :
   ...
   TH1F *h_photon_Et_range[125];
   TH1F *h_photonic_recoil[125];
   TH1F *h_phoRecoilMt[125];
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         pfMETPhi_T1JERUp;
   Float_t         pfMETPhi_T1JERDo;
   Float_t         pfMETPhi_T1JESUp;
   Float_t         pfMETPhi_T1JESDo;
   Float_t         pfMETPhi_T1MESUp;
   Float_t         pfMETPhi_T1MESDo;
   Float_t         pfMETPhi_T1EESUp;
   Float_t         pfMETPhi_T1EESDo;
   Float_t         pfMETPhi_T1PESUp;
   Float_t         pfMETPhi_T1PESDo;
   Float_t         pfMETPhi_T1TESUp;
   Float_t         pfMETPhi_T1TESDo;
   ...
   vector<int>     *AllClusteredEB;
   vector<int>     *AllCellsIEtaEB;
   vector<int>     *AllCellsIPhiEB;
   vector<float>   *AllTimeEB;
   vector<float>   *AllTimeErrEB;
   Int_t           nAllCellsEB;
   vector<float>   *AllCellsE_EB;
   ...
   TBranch        *b_pfMETPhi_T1JERUp;   //!
   TBranch        *b_pfMETPhi_T1JERDo;   //!
   TBranch        *b_pfMETPhi_T1JESUp;   //!
   TBranch        *b_pfMETPhi_T1JESDo;   //!
   TBranch        *b_pfMETPhi_T1MESUp;   //!
   TBranch        *b_pfMETPhi_T1MESDo;   //!
   TBranch        *b_pfMETPhi_T1EESUp;   //!
   TBranch        *b_pfMETPhi_T1EESDo;   //!
   TBranch        *b_pfMETPhi_T1PESUp;   //!
   TBranch        *b_pfMETPhi_T1PESDo;   //!
   TBranch        *b_pfMETPhi_T1TESUp;   //!
   TBranch        *b_pfMETPhi_T1TESDo;   //!
   ...
   TBranch        *b_AllClusteredEB;   //!
   TBranch        *b_AllCellsIEtaEB;   //!
   TBranch        *b_AllCellsIPhiEB;   //!
   TBranch        *b_AllTimeEB;   //!
   TBranch        *b_AllTimeErrEB;   //!
   TBranch        *b_nAllCellsEB;   //!
   TBranch        *b_AllCellsE_EB;   //!
   ...
   virtual vector<int> JetVetoDecision(int pho_index, int lep_index);
...
void postAnalyzer::Init(TChain *tree)
{
   ...
   fChain->SetBranchAddress("pfMETPhi_T1JERUp", &pfMETPhi_T1JERUp, &b_pfMETPhi_T1JERUp);
   fChain->SetBranchAddress("pfMETPhi_T1JERDo", &pfMETPhi_T1JERDo, &b_pfMETPhi_T1JERDo);
   ...
   fChain->SetBranchAddress("pfMETPhi_T1MESUp", &pfMETPhi_T1MESUp, &b_pfMETPhi_T1MESUp);
   fChain->SetBranchAddress("pfMETPhi_T1MESDo", &pfMETPhi_T1MESDo, &b_pfMETPhi_T1MESDo);
   fChain->SetBranchAddress("pfMETPhi_T1EESUp", &pfMETPhi_T1EESUp, &b_pfMETPhi_T1EESUp);
   fChain->SetBranchAddress("pfMETPhi_T1EESDo", &pfMETPhi_T1EESDo, &b_pfMETPhi_T1EESDo);
   ...
   fChain->SetBranchAddress("pfMETPhi_T1TESUp", &pfMETPhi_T1TESUp, &b_pfMETPhi_T1TESUp);
   fChain->SetBranchAddress("pfMETPhi_T1TESDo", &pfMETPhi_T1TESDo, &b_pfMETPhi_T1TESDo);
   ...
   fChain->SetBranchAddress("AllClusteredEB", &AllClusteredEB, &b_AllClusteredEB);
   fChain->SetBranchAddress("AllCellsIEtaEB", &AllCellsIEtaEB, &b_AllCellsIEtaEB);
   fChain->SetBranchAddress("AllCellsIPhiEB", &AllCellsIPhiEB, &b_AllCellsIPhiEB);
   fChain->SetBranchAddress("AllTimeEB", &AllTimeEB, &b_AllTimeEB);
   fChain->SetBranchAddress("AllTimeErrEB", &AllTimeErrEB, &b_AllTimeErrEB);
   fChain->SetBranchAddress("nAllCellsEB", &nAllCellsEB, &b_nAllCellsEB);
   fChain->SetBranchAddress("AllCellsE_EB", &AllCellsE_EB, &b_AllCellsE_EB);
