...
public :
   ...
   TH1F *h_nVtx[125],*h_metcut, *h_dphimin,*h_metFilters[125],*h_pfMETall[125],*h_pfMET200[125],*h_nJets[125],*h_pfMET[125],*h_pfMETPhi[125],*h_j1nCategory1[125],*h_j1nCategory2[125],*h_j1dRPF12_ID_1[125],*h_j1dRPF12_ID_2[125];
   TH1F *h_j1Pt[125], *h_j1Eta[125], *h_j1Phi[125], *h_j1etaWidth[125], *h_j1phiWidth[125],*h_j1nCons[125], *h_j1PF12PtFrac_ID_1[125], *h_j1PF12PtFrac_ID_2[125],*h_j1PFPtFrac_ID_2[125],*h_PF123PtFraction[125];  
   TH1F *h_j1TotPFCands[125], *h_j1ChPFCands[125], *h_j1NeutPFCands[125], *h_j1GammaPFCands[125], *h_j1CHF[125], *h_j1NHF[125], *h_j1ChMultiplicity[125], *h_j1NeutMultiplicity[125],*h_j1Mt[125];  
   //Category3 Histos
   TH1F *h_ChPionPt[125],*h_PhotonPt[125],*h_dRPionPhoton[125];
   TH1D *h_cutflow;

  TH2F *h_EcalPtUnc[125],*h_TrackerPtUnc[125],*h_HcalPtUnc[125];
  TH1F *h_TrackerPtFrac[125],*h_EcalPtFrac[125],*h_HcalPtFrac[125];
  //3Const.
  TH1F *h_j1PFCons1PtFraction[125],*h_j1PFCons2PtFraction[125],*h_j1PFCons3PtFraction[125];  
 ...
 //ROOT::Math::DisplacementVector2D<ROOT::Math::Cartesian2D<float>,ROOT::Math::DefaultCoordinateSystemTag> *caloMet;
  ...
  ZprimeJetsClass_MC(const char* file1,const char* file2,int min,int max);
   ...
   virtual vector<double>getPt123Frac(int UncType);
   virtual vector<double>getPtFrac(int UncType);
...
bool fileSelection(std::string filename, std::string dataset,int min, int max)
{
  ...
  //if (min < fileNum) return true;//my totka for running signalfiles
  else return false;
}
