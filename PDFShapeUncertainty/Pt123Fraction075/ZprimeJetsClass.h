...
public :
  ...
  TH1F *h_nVtx[10],*h_metcut, *h_dphimin,*h_metFilters[10],*h_pfMETall[10],*h_pfMET200[10],*h_nJets[10],*h_pfMET[10],*h_pfMETPhi[10],*h_j1nCategory1[10],*h_j1nCategory2[10],*h_j1dRPF12_ID_1[10],*h_j1dRPF12_ID_2[10];
  TH1F *h_j1Pt[10], *h_j1Eta[10], *h_j1Phi[10], *h_j1etaWidth[10], *h_j1phiWidth[10],*h_j1nCons[10], *h_j1PF12PtFrac_ID_1[10], *h_j1PF12PtFrac_ID_2[10],*h_j1PFPtFrac_ID_2[10],*h_PF123PtFraction[10];  
  TH1F *h_j1TotPFCands[10], *h_j1ChPFCands[10], *h_j1NeutPFCands[10], *h_j1GammaPFCands[10], *h_j1CHF[10], *h_j1NHF[10], *h_j1ChMultiplicity[10], *h_j1NeutMultiplicity[10],*h_j1Mt[10]; 
  //Category3 Histos
  TH1F *h_ChPionPt[10],*h_PhotonPt[10],*h_dRPionPhoton[10];
  TH1D *h_cutflow;

  TH2F *h_EcalPtUnc[10],*h_TrackerPtUnc[10],*h_HcalPtUnc[10];
  TH1F *h_TrackerPtFrac[10],*h_EcalPtFrac[10],*h_HcalPtFrac[10];
  //3Const.
  TH1F *h_j1PFCons1PtFraction[10],*h_j1PFCons2PtFraction[10],*h_j1PFCons3PtFraction[10];  
  ...
  virtual void fillHistos(std::vector<std::pair<int,double>> jetCand_to_use,int histoNumber);
