...
void ZprimeJetsClass_MC::AllPFCand(std::vector<pair<int,double>> jetCand,std::vector<int> PFCandidates)
{
...
std::vector<pair<int,double>> ZprimeJetsClass_MC::getJetCand(double jetPtCut, double jetEtaCut, double jetNHFCut, double jetCHFCut){
...
std::vector<int> ZprimeJetsClass_MC::JetVetoDecision(int jet_index, int mu_index) {
