...
*/
  c->SaveAs((std::string("/afs/hep.wisc.edu/home/uhussain/public_html/SingleMuCR_2016Full/Feb19/datamc_")+std::string(variable)+std::string("_2016Full.pdf")).c_str());
  c->SaveAs((std::string("/afs/hep.wisc.edu/home/uhussain/public_html/SingleMuCR_2016Full/Feb19/datamc_")+std::string(variable)+std::string("_2016Full.png")).c_str());
}
