...
void stack_plotterlogRebin()
{
  ...
  //opening the data file and adding "j1pT_15" histogram
  TFile *f_datafile_0 = new TFile("postMETdata_G.root");
  //TFile *f_datafile_1 = new TFile("postMETdata_1.root");
  TH1F *histo_j1EtaWidth_data_0_old = (TH1F*)f_datafile_0->Get("j1pT_15"); 
  ...
  //TH1F *histo_j1EtaWidth_data_1 = (TH1F*)f_datafile_1->Get("j1pT_15");
  ...
  TH1F *histo_j1EtaWidth_WJets_0_old = (TH1F*)f_WJets_0->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W1Jets_old = (TH1F*)f_W1Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W2Jets_old = (TH1F*)f_W2Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W3Jets_old = (TH1F*)f_W3Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W4Jets_old = (TH1F*)f_W4Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W5Jets_old = (TH1F*)f_W5Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W6Jets_old = (TH1F*)f_W6Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_W7Jets_old = (TH1F*)f_W7Jets->Get("j1pT_15");
  ...
  histo_j1EtaWidth_WJets_0->Scale((1.0/57025279)*1885.122*50690);
  histo_j1EtaWidth_W1Jets->Scale((1.0/39617081)*1885.122*1345);
  histo_j1EtaWidth_W2Jets->Scale((1.0/19914060)*1885.122*359.7);
  histo_j1EtaWidth_W3Jets->Scale((1.0/5795947)*1885.122*48.91);
  histo_j1EtaWidth_W4Jets->Scale((1.0/14907334)*1885.122*12.05);
  histo_j1EtaWidth_W5Jets->Scale((1.0/6200214)*1885.122*5.501);
  histo_j1EtaWidth_W6Jets->Scale((1.0/5288556)*1885.122*1.329);
  histo_j1EtaWidth_W7Jets->Scale((1.0/2382305)*1885.122*0.03216);
  ...
  TH1F *histo_j1EtaWidth_100to200_old = (TH1F*)f_Zvv_100to200->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_200to400_old = (TH1F*)f_Zvv_200to400->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_400to600_old = (TH1F*)f_Zvv_400to600->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_600to800_old = (TH1F*)f_Zvv_600to800->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_800to1200_old = (TH1F*)f_Zvv_800to1200->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_1200to2500_old = (TH1F*)f_Zvv_1200to2500->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_2500toInf_old = (TH1F*)f_Zvv_2500toInf->Get("j1pT_15");
  ...
  histo_j1EtaWidth_100to200->Scale((1.0/19026284)*1885.122*280.35);
  histo_j1EtaWidth_200to400->Scale((1.0/19611913)*1885.122*77.67);
  histo_j1EtaWidth_400to600->Scale((1.0/8842306)*1885.122*10.73);
  histo_j1EtaWidth_600to800->Scale((1.0/5763181)*1885.122*2.559);
  histo_j1EtaWidth_800to1200->Scale((1.0/2169896)*1885.122*1.1796);
  histo_j1EtaWidth_1200to2500->Scale((1.0/143919)*1885.122*0.28833);
  histo_j1EtaWidth_2500toInf->Scale((1.0/404725)*1885.122*0.006945);
  ...
  TH1F *histo_j1EtaWidth_G1Jets_old = (TH1F*)f_G1Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_G2Jets_old = (TH1F*)f_G2Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_G3Jets_old = (TH1F*)f_G3Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_G4Jets_old = (TH1F*)f_G4Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_G5Jets_old = (TH1F*)f_G5Jets->Get("j1pT_15");
  ...
  //Scaling
  histo_j1EtaWidth_G1Jets->Scale((1.0/11490000)*1885.122*17420);
  histo_j1EtaWidth_G2Jets->Scale((1.0/14375000)*1885.122*5391);
  histo_j1EtaWidth_G3Jets->Scale((1.0/49455800)*1885.122*1168);
  histo_j1EtaWidth_G4Jets->Scale((1.0/11582100)*1885.122*132.5);
  histo_j1EtaWidth_G5Jets->Scale((1.0/11611900)*1885.122*44.05);
...
//opening DYJetsToLL backgrounds
  ...
  TH1F *histo_j1EtaWidth_DY1Jets_old = (TH1F*)f_DY1Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY2Jets_old = (TH1F*)f_DY2Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY3Jets_old = (TH1F*)f_DY3Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY4Jets_old = (TH1F*)f_DY4Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY5Jets_old = (TH1F*)f_DY5Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY6Jets_old = (TH1F*)f_DY6Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY7Jets_old = (TH1F*)f_DY7Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_DY8Jets_old = (TH1F*)f_DY8Jets->Get("j1pT_15");
  ...
  histo_j1EtaWidth_DY1Jets->Scale((1.0/47644783)*1885.122*4895*1.23);
  histo_j1EtaWidth_DY2Jets->Scale((1.0/7855800)*1885.122*147.4*1.23);
  histo_j1EtaWidth_DY3Jets->Scale((1.0/8691200)*1885.122*40.99*1.23);
  histo_j1EtaWidth_DY4Jets->Scale((1.0/8937770)*1885.122*5.678*1.23);
  histo_j1EtaWidth_DY5Jets->Scale((1.0/8292150)*1885.122*1.367*1.23);
  histo_j1EtaWidth_DY6Jets->Scale((1.0/2668260)*1885.122*0.6304*1.23);
  histo_j1EtaWidth_DY7Jets->Scale((1.0/555134)*1885.122*0.1514*1.23);
  histo_j1EtaWidth_DY8Jets->Scale((1.0/398370)*1885.122*0.003565*1.23);
  ...
  TH1F *histo_j1EtaWidth_TTJets_old = (TH1F*)f_TTJets->Get("j1pT_15");
  ...
  histo_j1EtaWidth_TTJets->Scale((1.0/10139700)*1885.122*502.2);
 ...
 //addding some backgrounds like WW, WZ, ZZ	
  ...
  TH1F *histo_j1EtaWidth_WW_old = (TH1F*)f_WW->Get("j1pT_15");
  ...
  histo_j1EtaWidth_WW->Scale((1.0/6986980)*1885.122*118.7);
...
*/
  ...
  TH1F *histo_j1EtaWidth_WZ_old = (TH1F*)f_WZ->Get("j1pT_15");
  ...
  histo_j1EtaWidth_WZ->Scale((1.0/2995760)*1885.122*47.2);
...
*/
  ...
  TH1F *histo_j1EtaWidth_ZZ_old = (TH1F*)f_ZZ->Get("j1pT_15"); 
  ...
  histo_j1EtaWidth_ZZ->Scale((1.0/998014)*1885.122*16.6);
...
*/
 ...
 //opening QCD background files (METValue-binned samples)
  ...
  TH1F *histo_j1EtaWidth_Q1Jets_old = (TH1F*)f_Q1Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q2Jets_old = (TH1F*)f_Q2Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q3Jets_old = (TH1F*)f_Q3Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q4Jets_old = (TH1F*)f_Q4Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q5Jets_old = (TH1F*)f_Q5Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q6Jets_old = (TH1F*)f_Q6Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q7Jets_old = (TH1F*)f_Q7Jets->Get("j1pT_15");
  TH1F *histo_j1EtaWidth_Q8Jets_old = (TH1F*)f_Q8Jets->Get("j1pT_15");
  ...
  histo_j1EtaWidth_Q1Jets->Scale((1.0/80584300)*1885.122*27500000);
  histo_j1EtaWidth_Q2Jets->Scale((1.0/38742400)*1885.122*1735000);
  histo_j1EtaWidth_Q3Jets->Scale((1.0/37501400)*1885.122*367000);
  histo_j1EtaWidth_Q4Jets->Scale((1.0/43210300)*1885.122*29370);
  histo_j1EtaWidth_Q5Jets->Scale((1.0/29695500)*1885.122*6524);
  histo_j1EtaWidth_Q6Jets->Scale((1.0/10358900)*1885.122*1064);
  histo_j1EtaWidth_Q7Jets->Scale((1.0/7853460)*1885.122*121.5);
  histo_j1EtaWidth_Q8Jets->Scale((1.0/4045060)*1885.122*25.42);  
...
//  TH1F *histo_signal_1GeV = (TH1F*)f_signal_1GeVfile ->Get("j1pT_15");
...
//
  ...
  TH1F *histo_signal_5GeV_old = (TH1F*)f_signal_5GeVfile ->Get("j1pT_15");
  TH1F *histo_signal_5GeV = dynamic_cast<TH1F*>(histo_signal_5GeV_old->Rebin(28,"histo_signal_5GeV",xbins));
  histo_signal_5GeV->Scale((1.0/2133)*1885.122*0.047);
...
//  TH1F *histo_signal_20GeV = (TH1F*)f_signal_20GeVfile ->Get("j1pT_15");
//  histo_signal_20GeV->Scale((1.0/10000)*1885.122*0.034);
...
//  TH1F *histo_signal_50GeV = (TH1F*)f_signal_50GeVfile ->Get("j1pT_15");
//  histo_signal_50GeV->Scale((1.0/10000)*1885.122*0.025);
...
//  TH1F *histo_signal_10GeV = (TH1F*)f_signal_10GeVfile ->Get("j1pT_15");
...
//  TH1F *histo_signal_100GeV = (TH1F*)f_signal_100GeVfile ->Get("j1pT_15");
//  histo_signal_100GeV->Scale((1.0/10000)*1885.122*0.019);
...
//  leg->AddEntry(histo_signal_100GeV, "ZprimeSignal_mchi100GeV");
  ...
  xaxis->SetTitle("Leading Jet P_{T} (GeV)");
...
*/
  c->SaveAs("METXPlots/datamc_j1pT_15_Rebin.pdf");
  c->SaveAs("METXPlots/datamc_j1pT_15_Rebin.png");
}
